		...
		reader.onload = function(e) {
		    ...
		    for (i = 0; i < lines.length; ++i){
		    	...
		    	productObjects.push({
		    		...
		    		'name':properties[1],
		    		'preis':properties[5],
		    		'gewicht':properties[27],
		    		'zutaten':properties[30],
		    		'kj':properties[72],
		    		'kcal':properties[73],
		    		'eiweiss':properties[74],
		    		'fett':properties[75],
		    		'kohlenhydrate':properties[76],
		    		'gesFettS':properties[77],
		    		'zucker':properties[78],
		    		'ballaststoffe':properties[79],
		    		'kochsalz':properties[80],
		    		'broteinheiten':properties[81],
		    		'grammBE':properties[82],
		    		'allergene':properties[83]
		    	});
		    }
